...
const canWeDeliver = (zipCode) => {
    for (let i = 0; i < 5; i++) {
      if (deliveryAreaZipCodes[i] === zipCode) {
        ...
        console.log('Sorry we are unable to deliver to this address.')
      }
    }
};
...
const newDealsTitle = deals[0].title.replace('15', '10')

console.log(newDealsTitle)
...
const newDealsDesc = deals[1].desc.replace('March', 'April')
